...
<html lang="en">
    ...
    <div class="d-flex justify-content-center">
        <div class="d-flex flex-column f-weight">
            ...
            <ul class="nav nav-tabs mt-3" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="temp-tab" data-bs-toggle="tab" data-bs-target="#temp-tab-pane" type="button" role="tab" aria-controls="temp-tab-pane" aria-selected="false" onClick="window.location.href='/example/login-case/cookie/index.php'">쿠키 로그인</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="qr-tab" data-bs-toggle="tab" data-bs-target="#qr-tab-pane" type="button" role="tab" aria-controls="qr-tab-pane" aria-selected="false" onClick="window.location.href='/example/login-case/session/index.php'">세션 로그인</button>
                </li>
            </ul>
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active border border-top-0 rounded-bottom rounded-top-end" id="login-tab-pane" role="tabpanel" aria-labelledby="login-tab" tabindex="0">
                    <form id="loginForm" class="d-flex justify-content-center flex-column" action="/example/login.php" method="POST">
            ...
            <div class="d-flex justify-content-end">
                <a href="/example/signup.php" class="m-3 mt-1 text-decoration-none nav-item" style="cursor:pointer;">회원가입</a>
            </div>
        </div>
    </div>
  </body>
  ...
  <script>
    ...
    form.addEventListener('submit', function (e) {
        ...
        switch (selected) {
            case 'basic':
                form.action = '/example/login.php';
                break;
            case 'both':
                form.action = '/example/login-case/loginWithIdAndAuth.php';
                break;
            case 'sep':
                form.action = '/example/login-case/loginSepIdAndAuth.php';
                break;
            case 'bothHash':
                form.action = '/example/login-case/loginWithIdAndAuthAndHash.php';
                break;
            case 'sepHash':
                form.action = '/example/login-case/loginSepIdAndAuthAndHash.php';
                break;
        }
    });
    </script>
