        ...
        <div class="d-flex flex-column f-weight">
            ...
            <?php 
                if($Exists){
                    ...
                    echo "<button type='button' class='btn btn-success m-3' onClick='window.location.href=\"/example/login-case/cookie/logout.php\"'>다시 로그인</button>";
                } else {
                    echo '
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active border border-top-0 rounded-bottom rounded-top-end" id="login-tab-pane" role="tabpanel" aria-labelledby="login-tab" tabindex="0">
                            <form id="loginForm" class="d-flex justify-content-center flex-column" action="/example/login-case/cookie/cookieLogin.php" method="POST">
