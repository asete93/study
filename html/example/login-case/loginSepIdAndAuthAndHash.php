        ...
        <div class="d-flex flex-column f-weight">
            ...
            <div class="d-flex flex-column align-items-center">
                <?php
                    ...
                    // SQL인젝션 취약버전
                    $id_hash = $id . "_hash";
                    $sql = "SELECT * FROM users WHERE id = '$id_hash'";
                    ...
                    if($Exists){
                        ...
                        if($pass_hash == $db_pass){
                            ...
                            echo "<div class='text-center mb-2 fw-bold'>식별/인증 분리(Hash)</div>";
                            ...
                            echo "<div class='text-center mb-2 fw-bold'>식별/인증 분리(Hash)</div>";
                            echo "<div class='text-center mb-2 fw-bold'>올바르지 않은 패스워드 입니다.</div>";
                        ...
                        echo "<div class='text-center mt-5 fw-bold'>로그인 실패</div>";
                        echo "<div class='text-center mb-2 fw-bold'>식별/인증 분리(Hash)</div>";
                        echo "<div class='text-center mb-2 fw-bold'>올바르지 않은 아이디 입니다.</div>";
                        echo "<button type='button' class='btn btn-success m-3' onClick='history.back()'>다시시도</button>";
                    }
                ?>
            </div>
