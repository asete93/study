        ...
        <div class="d-flex flex-column f-weight">
            ...
            <?php 
                if($Exists){
                    ...
                    echo "<button type='button' class='btn btn-success m-3' onClick='window.location.href=\"/login-case/cookie/logout.php\"'>다시 로그인</button>";
                } else {
                    echo '
                    <ul class="nav nav-tabs mt-3" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="temp-tab" data-bs-toggle="tab" data-bs-target="#temp-tab-pane" type="button" role="tab" aria-controls="temp-tab-pane" aria-selected="false" onClick="window.location.href=\'/index.php\'">이전으로</button>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active border border-top-0 rounded-bottom rounded-top-end" id="login-tab-pane" role="tabpanel" aria-labelledby="login-tab" tabindex="0">
                            <form id="loginForm" class="d-flex justify-content-center flex-column" action="/login-case/cookie/cookieLogin.php" method="POST">
                                ...
                                <button type="submit" class="btn btn-success m-3">쿠키 로그인</button>
                            </form>
                        </div>
